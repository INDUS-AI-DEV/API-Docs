const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'configs/current/callback', page: 'developer-agent-management', id: 'developer-agent-management-patch-configs-current-callback', method: 'PATCH' },
      { label: 'Post-Call Callback Flow', page: 'developer-agent-management', id: 'developer-agent-management-post-call-callback-flow' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'refresh_token', page: 'developer-click2call', id: 'developer-click2call-post-refresh-token', method: 'POST' },
      ...
      { label: 'calls/{call_id}/transcript/retry', page: 'developer-click2call', id: 'developer-click2call-post-transcript-retry', method: 'POST' },
      { label: 'mobile-numbers', page: 'developer-click2call', id: 'developer-click2call-get-mobile-numbers', method: 'GET' },
      { label: 'mobile-numbers/channel-allocation', page: 'developer-click2call', id: 'developer-click2call-get-channel-allocation', method: 'GET' },
      { label: 'mobile-numbers/channel-allocation', page: 'developer-click2call', id: 'developer-click2call-put-channel-allocation', method: 'PUT' },
      { label: 'mobile-numbers/channel-allocation', page: 'developer-click2call', id: 'developer-click2call-patch-channel-allocation', method: 'PATCH' },
      { label: 'channel-allocation/utilization', page: 'developer-click2call', id: 'developer-click2call-get-channel-utilization', method: 'GET' },
      { label: 'calls/inbound-callback-url', page: 'developer-click2call', id: 'developer-click2call-post-inbound-callback-url', method: 'POST' },
      { label: 'calls/inbound-callback-url', page: 'developer-click2call', id: 'developer-click2call-get-inbound-callback-url', method: 'GET' },
      { label: 'calls/call-log', page: 'developer-click2call', id: 'developer-click2call-post-call-log', method: 'POST' },
      { label: 'DID Channel Capacity Model', page: 'developer-click2call', id: 'developer-click2call-capacity-model' },
