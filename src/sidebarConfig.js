const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'agents/', page: 'developer-agent-management', id: 'developer-agent-management-get-agents', method: 'GET' },
      ...
      { label: 'team', page: 'developer-agent-management', id: 'developer-agent-management-post-team', method: 'POST' },
      { label: 'stats', page: 'developer-agent-management', id: 'developer-agent-management-get-stats', method: 'GET' },
      ...
      { label: 'live-sessions', page: 'developer-agent-management', id: 'developer-agent-management-get-live-sessions', method: 'GET' },
