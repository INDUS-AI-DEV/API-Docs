  ...
  return (
    <section className={styles.endpointSection} id="swarmitra-emotional-models">
      ...
      <p style={{ marginTop: '0.5rem' }}>
        Unlock deeper insights with <code>swarmitra-v2</code>. These specialized models go beyond transcription to detect <strong>emotional nuance</strong> in <strong>Hindi</strong> and <strong>English</strong> speech.
      </p>
